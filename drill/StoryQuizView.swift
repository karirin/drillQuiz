...
let monsters: [String: Monster] = [
    ...
    "ボス15": Monster(name: "ボス15", playerExperience: 500, playerMoney: 1000, monsterHP: 3000, monsterUnderHP: 3000, monsterAttack: 500),
...
struct StoryListView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        StorySansuListView(isPresenting: .constant(false), monsterName: "モンスター2", backgroundName: "ダンジョン背景1", viewModel: PositionViewModel.shared)
    }
}
